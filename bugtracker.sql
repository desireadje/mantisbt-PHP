...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 19 Novembre 2020 à 04:45
...
(1, 'Applications de Gestion des Plaintes & Réclamations Client', 10, 1, 10, 10, '', 'Applications de Gestion des Plaintes & Réclamations Client', 1, 1);
...
(3, 1, 5, '{"filter":true,"profile":true}', 1605720055, 1637264500),
(7, 1, 4, '1', 1605728415, 1605728715);
...
(1, 'administrator', 'Désiré Adjé', 'adesire@ebenyx.com', '200ceb26807d6bf99fd6f4f0d1ca54d4', 1, 0, 90, 12, 0, 0, '0CsZ27FLaW4idSGNngWdWxUGwite77uUzX2ZaRXwHOBCPr_sbPviLB9HtWsuu-AG', 1605728496, 1605717395);
